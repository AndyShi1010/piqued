...
<svg 
  ...
  {:else if weight === "duotone"}
    <g opacity="0.2"><rect x="52" y="52" width="152" height="152" rx="6.9"/></g><path d="M197.1,212H58.9A14.9,14.9,0,0,1,44,197.1V58.9A14.9,14.9,0,0,1,58.9,44H197.1A14.9,14.9,0,0,1,212,58.9V197.1A14.9,14.9,0,0,1,197.1,212ZM60,196H196V60H60Z"/>
  {:else if weight === "fill"}
