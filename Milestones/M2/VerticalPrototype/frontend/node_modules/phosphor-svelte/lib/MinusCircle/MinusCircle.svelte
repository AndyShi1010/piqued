...
<svg 
  ...
  {:else if weight === "duotone"}
    <g opacity="0.2"><circle cx="128" cy="128" r="96"/></g><path d="M128,24A104,104,0,1,0,232,128,104.1,104.1,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Z"/><path d="M168,120H88a8,8,0,0,0,0,16h80a8,8,0,0,0,0-16Z"/>
  {:else if weight === "fill"}
