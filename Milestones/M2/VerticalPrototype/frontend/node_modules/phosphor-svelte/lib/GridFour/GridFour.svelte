...
<svg 
  ...
  {:else if weight === "duotone"}
    <g opacity="0.2"><path d="M128,128H44V52a8,8,0,0,1,8-8h76Z"/></g><path d="M204,36H52A16,16,0,0,0,36,52V204a16,16,0,0,0,16,16H204a16,16,0,0,0,16-16V52A16,16,0,0,0,204,36Zm0,84H136V52h68ZM120,52v68H52V52ZM52,136h68v68H52Zm152,68H136V136h68v68Z"/>
  {:else if weight === "fill"}
