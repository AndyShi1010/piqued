...
<svg 
  ...
  {:else if weight === "duotone"}
    <path d="M224,128a96,96,0,0,1-96,96V32A96,96,0,0,1,224,128Z" opacity="0.2"/><path d="M128,24A104,104,0,1,0,232,128,104.1,104.1,0,0,0,128,24ZM40,128a88.1,88.1,0,0,1,80-87.6V215.6A88.1,88.1,0,0,1,40,128Zm96,87.6V40.4a88,88,0,0,1,0,175.2Z"/>
  {:else if weight === "fill"}
