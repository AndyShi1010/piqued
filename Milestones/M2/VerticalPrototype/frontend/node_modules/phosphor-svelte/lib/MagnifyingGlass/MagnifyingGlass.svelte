...
<svg 
  ...
  {:else if weight === "duotone"}
    <g opacity="0.2"><circle cx="116" cy="116" r="84"/></g><path d="M229.7,218.3l-43.3-43.2a92.2,92.2,0,1,0-11.3,11.3l43.2,43.3a8.2,8.2,0,0,0,11.4,0A8.1,8.1,0,0,0,229.7,218.3ZM40,116a76,76,0,1,1,76,76A76.1,76.1,0,0,1,40,116Z"/>
  {:else if weight === "fill"}
