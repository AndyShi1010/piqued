...
<svg 
  ...
  {:else if weight === "duotone"}
    <path d="M176,108l48,60H40V48H224Z" opacity="0.2"/><path d="M186.2,108l44-55A8,8,0,0,0,224,40H40a8,8,0,0,0-8,8V216a8,8,0,0,0,16,0V176H224a8,8,0,0,0,6.2-13ZM48,160V56H207.4l-37.6,47a7.8,7.8,0,0,0,0,10l37.6,47Z"/>
  {:else if weight === "fill"}
