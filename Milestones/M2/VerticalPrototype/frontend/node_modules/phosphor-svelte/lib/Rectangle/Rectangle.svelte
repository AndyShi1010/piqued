...
<svg 
  ...
  {:else if weight === "duotone"}
    <g opacity="0.2"><rect x="32" y="48" width="192" height="160" rx="8"/></g><path d="M216,216H40a16,16,0,0,1-16-16V56A16,16,0,0,1,40,40H216a16,16,0,0,1,16,16V200A16,16,0,0,1,216,216ZM40,56V200H216V56Z"/>
  {:else if weight === "fill"}
